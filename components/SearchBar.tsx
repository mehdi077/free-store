  ...
  return (
    <div className="w-full max-w-3xl px-2">
      <Form action='/search' className="relative flex gap-2">
          ...
          <button
            type="submit"
            className="h-[39px] sm:px-4 bg-gray-900 text-white rounded-lg hover:bg-[#0068D7]/90 transition-colors flex items-center justify-center sm:justify-start sm:gap-2 sm:text-[14px] w-[39px] sm:w-auto"
